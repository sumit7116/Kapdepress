...
public class SteamIroninDailyWearClothsAdapter extends RecyclerView.Adapter<SteamIroninDailyWearClothsAdapter.ViewHolder> {
    private List<SteamIroninDailyWearClothsModel> list_data;
    private Context context;
    private int mainCount=1;

    public SteamIroninDailyWearClothsAdapter(List<SteamIroninDailyWearClothsModel> list_data, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        SteamIroninDailyWearClothsAdapter.ViewHolder viewHolder = new SteamIroninDailyWearClothsAdapter.ViewHolder(listItem);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        SteamIroninDailyWearClothsModel listData=list_data.get(position);
        holder.txt_clothName.setText(listData.getClothName());
        holder.txt_price.setText("Rs. "+listData.getClothPrice()+"/Cloth");
        holder.txt_quantity.setText(listData.getClothQuantity());
        //holder.img_cloth.setImageResource(SteamIroninDailyWearClothsModel[position].getClothImg());
        Glide.with(holder.img_cloth.getContext()).load(listData.getClothImg()).placeholder(R.drawable.bwlogo).into(holder.img_cloth);
